-- ============================================
-- MIGRATION RAPIDE - Copier-coller tout ce fichier
-- ============================================
-- Instructions: 
...
-- ÉTAPE 5: Fonction get_category_path
...
-- ÉTAPE 7: Nettoyer les anciennes données (optionnel - décommente si nécessaire)
-- TRUNCATE TABLE categories CASCADE;

-- ÉTAPE 8: Insérer les catégories principales
...
-- ÉTAPE 9: Insérer les sous-catégories TÉLÉPHONES
INSERT INTO categories (id, name, slug, parent_id, icon, description, sort_order) VALUES
...
-- ÉTAPE 10: Insérer les sous-catégories ORDINATEURS
INSERT INTO categories (id, name, slug, parent_id, icon, description, sort_order) VALUES
...
-- ÉTAPE 11: Insérer les sous-catégories ACCESSOIRES
INSERT INTO categories (id, name, slug, parent_id, icon, description, sort_order) VALUES
...
-- ÉTAPE 12: Insérer les sous-catégories PIÈCES DÉTACHÉES
INSERT INTO categories (id, name, slug, parent_id, icon, description, sort_order) VALUES
...
-- ÉTAPE 13: Insérer les sous-catégories APPAREILS ÉLECTRONIQUES
INSERT INTO categories (id, name, slug, parent_id, icon, description, sort_order) VALUES
...
-- ÉTAPE 14: Insérer les sous-catégories SERVICES
INSERT INTO categories (id, name, slug, parent_id, icon, description, sort_order) VALUES
